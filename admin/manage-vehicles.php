...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,tblvehicles.VehicleId,tblvehicles.DriverEmail,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->DriverEmail);?></td>
