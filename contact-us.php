        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            <div class="form-group">
              ...
              <input type="text" name="fullname" class="form-control white_bg" id="fullname"  pattern="[A-Za-z]+" required>
            </div>
            <div class="form-group">
              <label class="control-label">Email Address <span>*</span></label>
              <input type="email" name="email" class="form-control white_bg" id="emailaddress"  pattern="[a-zA-Z0-9._]+@[a-zA-Z0-9._]+\.[a-zA-Z]{2,5}" required>
            </div>
            <div class="form-group">
              <label class="control-label">Phone Number <span>*</span></label>
              <input type="text" name="contactno" class="form-control white_bg" id="phonenumber"  pattern="[9]{1}[6-8]{1}[0-9]{8}" required>
            </div>
            <div class="form-group">
